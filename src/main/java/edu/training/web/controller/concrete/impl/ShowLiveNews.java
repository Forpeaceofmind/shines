...
public class ShowLiveNews implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			List<News> liveNews = newsService.getNewsByCategory("live"); 
			request.setAttribute("liveNews", liveNews);
			RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/jsp/live_news.jsp");
